  ...
  return (
    <div className="w-screen md:w-full flex items-center justify-center">
      <div className="bg-white mx-3 rounded-full md:h-36 w-[80%] md:w-20 p-2 flex md:flex-col items-center justify-between mb-2 md:mb-0">
        <div className={`${aqi === 1 ? 'bg-green-700' : aqi === 2 ? 'bg-green-300' : aqi === 3 ? 'bg-amber-300' : aqi === 4 ? 'bg-orange-500' : 'bg-red-700'} w-10 h-10 md:w-14 md:h-14 text-lg rounded-full flex flex-col items-center justify-center md:mb-8 order-last md:order-first`}>
          <p>{aqi}</p>
        </div>
